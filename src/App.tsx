...
const RivalLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M50 5 L50 95 M5 50 L95 50 M18 18 L82 82 M18 82 L82 18" stroke="currentColor" strokeWidth="8" strokeLinecap="round"/>
  </svg>
);
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center py-6 px-4">
      <div className="w-full max-w-6xl glass rounded-full px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <RivalLogo className="w-8 h-8 text-rival-green" />
          <span className="font-display text-xl tracking-tighter font-bold uppercase">Rival™</span>
        </div>
        
        <div className="hidden md:flex items-center gap-8 text-sm font-medium uppercase tracking-widest">
          <a href="#about" className="hover:text-rival-green transition-colors">About</a>
          <a href="#results" className="hover:text-rival-green transition-colors">Results</a>
          <a href="#membership" className="hover:text-rival-green transition-colors">Membership</a>
...
const FeatureCard = ({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) => (
  <motion.div 
    whileHover={{ y: -10 }}
    className="p-8 glass-dark rounded-3xl border-white/5 hover:border-rival-green/30 transition-all duration-500"
  >
    <div className="w-12 h-12 bg-rival-green rounded-2xl flex items-center justify-center mb-6 text-rival-dark">
...
const ResultsCard = () => (
  <div className="relative group">
    <div className="absolute -inset-1 bg-rival-green opacity-20 blur-xl group-hover:opacity-40 transition-opacity"></div>
    <div className="relative glass bg-white/5 backdrop-blur-2xl rounded-[40px] p-12 overflow-hidden border-white/10">
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="w-full md:w-1/2">
          <span className="text-rival-green font-display uppercase tracking-widest mb-4 inline-block">Success Story</span>
          <h2 className="text-4xl md:text-5xl font-serif leading-tight mb-8 italic">
            "I feel like myself again. Rival changed my entire outlook."
          </h2>
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-rival-muted overflow-hidden">
               <img src="https://i.pravatar.cc/150?u=josh" alt="Josh" className="w-full h-full object-cover" />
            </div>
            <div>
              <p className="font-bold text-lg">Josh Miller</p>
              <p className="text-gray-400">Software Engineer | Member since 2024</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 bg-white/5 rounded-3xl p-8 border border-white/10">
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-rival-green text-2xl italic font-serif">41</span>
            </div>
          </div>
...
const App = () => {
  ...
  return (
    <div className="min-h-screen selection:bg-rival-green selection:text-rival-dark">
      <Navbar />
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-rival-dark via-rival-dark/20 to-rival-dark/80"></div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <span className="inline-block px-4 py-1 rounded-full glass text-rival-green text-xs font-bold uppercase tracking-[0.3em] mb-8">
            ...
            <h1 className="text-7xl md:text-9xl font-display font-extrabold tracking-tighter uppercase mb-6 leading-[0.8]">
              Feel Like <br /> <span className="text-rival-green italic font-serif leading-tight">Yourself</span> Again
            </h1>
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce flex flex-col items-center gap-2">
           ...
           <div className="w-[1px] h-10 bg-gradient-to-b from-rival-green to-transparent"></div>
        </div>
      </section>
      ...
      <section id="membership" className="py-32 container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          {['Core Performance', 'Elite Biological'].map((plan, i) => (
            <div key={i} className={`glass p-12 rounded-[40px] flex flex-col border ${i === 1 ? 'border-rival-green bg-rival-green/5' : 'border-white/10'}`}>
              <div className="flex justify-between items-start mb-8">
                <div>
                   <h3 className="text-3xl font-display font-bold uppercase mb-2">{plan}</h3>
                   <p className="text-gray-400 text-sm">Monthly Investment</p>
                </div>
                <div className="text-4xl font-display font-bold text-rival-green">
                  ${i === 0 ? '249' : '499'}
                </div>
              </div>
              <ul className="space-y-4 mb-12 flex-grow">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3 text-sm">
                    <CheckCircle2 size={16} className="text-rival-green" /> {feat}
                  </li>
                ))}
              </ul>
      ...
      <section id="contact" className="py-32 container mx-auto px-6">
        <div className="glass rounded-[50px] overflow-hidden flex flex-col md:flex-row min-h-[600px] border-white/5">
          <div className="w-full md:w-1/2 p-12 md:p-20 flex flex-col justify-center bg-rival-green text-rival-dark">
             ...
             <p className="text-rival-dark/70 text-lg mb-12 font-medium">
               Complete the application below. Our Bio-Architects will contact you 
               for a facility tour and baseline assessment.
             </p>
             <div className="space-y-4">
               <div className="flex items-center gap-4"><Mail size={20} /> hello@rivalgym.com</div>
               <div className="flex items-center gap-4"><Phone size={20} /> (555) 890-2341</div>
               <div className="flex items-center gap-4"><MapPin size={20} /> 122 Science Ave, Industry District</div>
             </div>
          </div>
          
          <div className="w-full md:w-1/2 p-12 md:p-20 bg-rival-charcoal/50">
            {formStatus === 'success' ? (
              <motion.div 
              ...
              >
                <div className="w-20 h-20 bg-rival-green rounded-full flex items-center justify-center mb-6 text-rival-dark">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-2">
                  ...
                  <input required type="text" className="w-full bg-white/5 border-b-2 border-white/10 p-4 outline-none focus:border-rival-green transition-colors font-display" placeholder="CHRIS BUMSTEAD" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest font-bold text-gray-500">Email Address</label>
                  <input required type="email" className="w-full bg-white/5 border-b-2 border-white/10 p-4 outline-none focus:border-rival-green transition-colors font-display" placeholder="CHRIS@BUMSTEAD.CO" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest font-bold text-gray-500">Primary Goal</label>
                  <select className="w-full bg-white/5 border-b-2 border-white/10 p-4 outline-none focus:border-rival-green transition-colors font-display appearance-none">
                    <option className="bg-rival-dark">Hypertrophy</option>
                    <option className="bg-rival-dark">Longevity & Bio-Hacking</option>
                    <option className="bg-rival-dark">Fat Loss</option>
                    <option className="bg-rival-dark">Elite Performance</option>
                  </select>
                </div>
      ...
      <footer className="py-20 border-t border-white/5">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex flex-col items-center md:items-start gap-4">
            <div className="flex items-center gap-2">
              <RivalLogo className="w-6 h-6 text-rival-green" />
              <span className="font-display font-bold uppercase tracking-tighter">Rival™</span>
            </div>
            <p className="text-gray-500 text-xs">© 2026 RIVAL BIOLOGICAL ALLIANCE. ALL RIGHTS RESERVED.</p>
          </div>
          
          <div className="flex gap-8">
            <a href="#" className="hover:text-rival-green transition-colors"><Camera size={20} /></a>
            <a href="#" className="hover:text-rival-green transition-colors"><Share2 size={20} /></a>
            <a href="#" className="hover:text-rival-green transition-colors"><Globe size={20} /></a>
          </div>
